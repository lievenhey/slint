...
pub mod skia {
    ...
    #[no_mangle]
    pub unsafe extern "C" fn slint_skia_renderer_raw_vulkan_instance_handle(
    ...
    #[no_mangle]
    pub unsafe extern "C" fn slint_skia_renderer_raw_vulkan_physical_device_handle(
        r: SkiaRendererOpaque,
    ) -> u64 {
        let r = &*(r as *const SkiaRenderer);
        let vulkan_surface = r
    ...
    pub unsafe extern "C" fn slint_skia_renderer_raw_vulkan_device_handle(
        ...
        let vulkan_surface = r
            ...
            .downcast_ref::<VulkanSurface>()
            .expect("vulkan backend not in use");
        return vulkan_surface.raw_vulkan_device_handle();
    }
    ...
    pub unsafe extern "C" fn slint_skia_renderer_raw_vulkan_queue_handle(
        ...
        let vulkan_surface = r
            ...
            .downcast_ref::<VulkanSurface>()
            .expect("vulkan backend not in use");
        vulkan_surface.raw_vulkan_queue_handle()
    }
